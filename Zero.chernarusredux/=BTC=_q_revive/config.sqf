...
btc_qr_time = 600; //time in seconds for revive (0 = no time limit)
...
btc_qr_def_spawn = ["respawn_west","Golova","Kamenka","Berezino","Kameshovo","Rify"]; //Markers names where you want to spawn
btc_qr_cam_dist = 50;
